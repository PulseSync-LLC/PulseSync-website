...
export default function Privacy() {
    return (
        <Layout headerColor="#171821" title="Политика о персональных данных">
                    ...
                    <div className={styles.sectionWrapper}>
                        <div className={policy.main}>
                            ...
                            <div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        ИП «Деднев Григорий Дмитриевич»
                                        (далее — Оператор).
                                    </div>
                                    <div>
                                        1.1. Оператор ставит своей важнейшей
                                        целью и условием осуществления своей
                                    ...
                                    <div>
                                        <p>
                                            ...
                                            применяется ко всей информации,
                                            которую Оператор может получить о
                                ...
                                <div>
                                    ...
                                    <div>
                                        <p>
                                            ...
                                            и баз данных, обеспечивающих их
                                            доступность в сети интернет по
                                            сетевому адресу{' '}
                                            <a href="https://pulsesync.dev/">
                                                https://pulsesync.dev/
                                            </a>
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            необходимую информацию в течение 10
                                ...
                                <div>
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            его персональных данных, их
                                            блокирования или уничтожения в
                                            случае, если персональные данные
                                            ...
                                            принимать предусмотренные законом
                            ...
                            <div>
                                ...
                                <div>
                                    <div>
                                        6.1. Цель обработки предоставление
                                    ...
                                    <div>
                                        <p>
                                            6.2. Персональные данные: перечень
                                            собираемых и обрабатываемых
                                            персональных данных описан в пятом
                                            пункте политики конфиденциальности,
                                    ...
                                    <div>
                                        6.3. Правовые основания: Федеральный
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        7.5. Обработка персональных данных
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        8.2. Персональные данные Пользователя
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <p>
                                                ...
                                                момент отозвать свое согласие на
                                                обработку персональных данных,
                                                направив Оператору уведомление
                                                посредством электронной почты на
                                                электронный адрес Оператора{' '}
                                                <a href="mailto:info@pulsesync.dev">
                                                    info@pulsesync.dev
                                                </a>{' '}
                                                с пометкой «Отзыв согласия на
                                                обработку персональных данных».
                                            </p>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        действия третьих лиц, в том числе
                                        указанных в настоящем пункте поставщиков
                                        услуг.
                                    </div>
                                    <div>
                                        8.6. Установленные субъектом
                                    ...
                                    <div>
                                        ...
                                        отзыв согласия субъектом персональных
                                        данных или требование о прекращении
                            ...
                            <div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        намерении осуществлять трансграничную
                                        передачу персональных данных (такое
                                        уведомление направляется отдельно от
                                        уведомления о намерении осуществлять
                                        обработку персональных данных).
                                    </div>
                                    <div>
                            ...
                            <div>
                                ...
                                <div>
                                    <div>
                                        <p>
                                            12.1. Пользователь может получить
                                            любые разъяснения по интересующим
                                            вопросам, касающимся обработки его
                                            персональных данных, обратившись к
                                            Оператору с помощью электронной
                                            почты{' '}
                                            <a href="mailto:info@pulsesync.dev">
                                                info@pulsesync.dev
                                            </a>
                                    ...
                                    <div>
                                        12.2. В данном документе будут отражены
                                    ...
                                    <div>
                                        <p>
                                            ...
                                            Интернет по адресу{' '}
                                            <a href="https://pulsesync.dev/privacy">
                                                https://pulsesync.dev/privacy
                                            </a>
                                            .
                                        </p>
                                    </div>
